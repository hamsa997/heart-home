...
import { Sparkles, ArrowLeft, Loader2, PawPrint } from "lucide-react";
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="flex justify-end gap-4">
            ...
            <Button type="submit" className="bg-primary hover:bg-primary/90 text-white h-12 px-12 rounded-xl text-lg font-bold shadow-lg">
              Publish Profile
            </Button>
          </div>
        </form>
